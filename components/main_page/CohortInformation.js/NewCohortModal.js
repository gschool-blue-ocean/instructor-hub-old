            ...
            {newCohortModal ? (
                <>
                    ...
                    <div className={styles.newCohortModal}>
                        <form className={styles.newCohortForm} id='form' onSubmit={resClick}>
                            <label for='cohortName'>Name of Cohort</label><br/>
                            <input 
                                type='text' 
                                id='cohortName' 
                                name="cohortName" 
                            ...
                            <input 
                                ...
                                />
                                <br/>
                            <label for='instructorName'>Name of Instructor</label><br/>
                            <input 
                                type="text" 
                                id='instructor' 
